...
lemma smulX_eq (hn : n ≠ 0) :
  ...
  simp only [φ, ψᵤ, map_sub, map_mul, map_pow, div_add_div_same]
...
instance : AddGroup (curve⟮Universal.Field⟯) := inferInstance
...
lemma addXYZ_smulEval (m n : ℤ) :
  ...
  rw [← Jacobian.comp_smul, ← addXYZ_smulRing, ← map_addXYZ, curveRing_map_ringEval]
